...
1. **Fed 대차대조표·준비금 — 완화 방향 [+1점]:** Fed 공급요인 6,790.919 USD bn (+53.715 USD bn), 지급준비금 2,991.310 USD bn (+62.025 USD bn).
2. **Treasury 현금흐름·조달 — 완화 방향 [+1점]:** TGA 843.705 USD bn, 이전 공표 대비 -36.314 USD bn; 향후 14일 예정 경매 총액 278.000 USD bn(총발행, 순발행 아님).
3. **단기자금시장 완충·스트레스 — 자금시장 안정·중립 [0점]:** SOFR 3.62%, IORB 3.65%, 금리 차 -3.0bp; ON RRP 4.736 USD bn (+4.304 USD bn); SRF 미확보.
4. **시장 전달 결과 — 점수 제외·미확인:** 신용스프레드·주식 시장 폭·달러·장기금리의 동시 확인 자료가 없어 실제 위험자산 전달 여부와 판정 신뢰도는 **미확인**입니다.

**점수 합계: +2점.** 1층 +1, 2층 +1, 3층 0을 합산한 결과입니다. 4층이 미확인이므로 방향 점수는 표시하되 **판정 신뢰도는 낮음**입니다.
...
- **연준 유동성 공급요인 · 지급준비금:** 9월 9일 기준 주간 자료이며 9월 10일 발표분입니다. **상태: 최신 · 신규 공표 반영**
