...
1. **Fed 대차대조표·준비금 — 중립 [0점]:** Fed 공급요인 6,737.204 USD bn (+0.000 USD bn), 지급준비금 2,929.285 USD bn (+0.000 USD bn).
2. **Treasury 현금흐름·조달 — 긴축 방향 [-1점]:** TGA 880.019 USD bn, 이전 공표 대비 +879.130 USD bn; 향후 14일 예정 경매 총액 0.000 USD bn(총발행, 순발행 아님).
3. **단기자금시장 완충·스트레스 — 완화 방향 [+1점]:** SOFR 3.64%, IORB 3.65%, 금리 차 -1.0bp; ON RRP 0.432 USD bn (-0.194 USD bn); SRF 미확보.
4. **시장 전달 결과 — 점수 제외·미확인:** 신용스프레드·주식 시장 폭·달러·장기금리의 동시 확인 자료가 없어 실제 위험자산 전달 여부와 판정 신뢰도는 **미확인**입니다.

**점수 합계: 0점.** 1층 0, 2층 -1, 3층 +1을 합산한 결과입니다. 4층이 미확인이므로 방향 점수는 표시하되 **판정 신뢰도는 낮음**입니다.
...
- **연준 유동성 공급요인 · 지급준비금:** 9월 2일 기준 주간 자료이며 9월 3일 발표분입니다. **상태: 최신 · 다음 정기 발표 대기**

- **SOFR · EFFR:** 최신 영업일 금리와 거래량을 반영했습니다. **상태: 최신 · 신규 공표 반영**

- **ON RRP · 미 재무부 TGA:** 최신 일별 잔액을 반영했습니다. **상태: 최신 · 신규 공표 반영**

- **IORB:** 현재 적용되는 정책금리입니다. **상태: 최신 · 다음 정기 발표 대기**
