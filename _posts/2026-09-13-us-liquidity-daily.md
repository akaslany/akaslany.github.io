...
2. **Treasury 현금흐름·조달 — 완화 방향 [+1점]:** TGA 818.110 USD bn, 이전 공표 대비 -817,291.890 USD bn; 향후 14일 예정 경매 총액 278.000 USD bn(총발행, 순발행 아님).
3. **단기자금시장 완충·스트레스 — 자금시장 안정·중립 [0점]:** SOFR 3.62%, IORB 3.65%, 금리 차 -3.0bp; ON RRP 5.255 USD bn (+0.000 USD bn); SRF 미확보.
...
- **ON RRP:** 새 공표 없음 — 최신값 5.255 USD bn
- **미 재무부 TGA:** 새 공표 없음 — 최신값 818.110 USD bn
...
유효기간은 2026-09-27까지 또는 다음 핵심 공표·결제 직후 중 먼저 도래하는 때까지다.
